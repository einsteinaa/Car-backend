...
<div class="page-top">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2><?php echo e($category_data->category_name); ?></h2>
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">Home</a></li>
               
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($category_data->category_name); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="category-page-post-item">
                                ...
                                <div class="category">
                                    <span class="badge bg-success"><?php echo e($category_data->category_name); ?></span>
                                </div>
