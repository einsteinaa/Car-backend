    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h2>All posts of <?php echo e($updated_date); ?></h2>
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">Home</a></li>
               
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($updated_date); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
