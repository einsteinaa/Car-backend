...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('admin_profile_submit')); ?>" method="post"
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\car rental system project\Car_Rent\car_rent_admin\resources\views/admin/profile.blade.php ENDPATH**/ ?>