            ...
            <div class="col-md-12">
                ...
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('allcategory',$post_detail->category_id) }}">{{$post_detail->rAllCategory->category_name  }}</a></li>
...
<div class="page-content">
    <div class="container">
        <div class="row">
            ...
            @if($post_detail->post_photo_src)
                    <p style="color:#969696"><i>{{ $post_detail->post_photo_src }}</i></p>
                  @endif
                ...
                <div class="sub">
                    ...
                    <div class="item">
                        ...
                        <a href="{{ route('allcategory',$post_detail->category_id) }}">{{ $post_detail->rAllCategory->category_name }}</a>
                    </div>
                    <div class="item">
                ...
                @if($post_detail->post_detail_src)
                <p style="color:#969696"><i>{{ $post_detail->post_detail_src }}</i></p>
              @endif
