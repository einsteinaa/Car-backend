                        ...
                        <div class="photo">
                            ...
                            <div class="text">
                                <div class="text-inner">
                                    <div class="category">
                                        <span class="badge bg-success badge-sm">{{ $item->rAllCategory->category_name }}</span>
                                    </div>
                            ...
                            <div class="news-total-item">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 see-all">
                                        <a href="{{ route('allcategory',$item->id) }}" class="btn btn-primary btn-sm">See All News</a>
                                        ...
                                        <div class="right-side">
                                            ...
                                            <div class="right-side-item">
                                                ...
                                                <div class="right">
                                                    ...
                                                    <h2 class="mb-3"><a  href="{{ route('news_detail',$single->id) }}">  {{ $single->post_title }}</a></h2>
