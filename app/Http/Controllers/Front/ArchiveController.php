...
class ArchiveController extends Controller
{
    ...
    public function detail($year,$month){
        // $post_data_archive = Post::with('rSubCategory')->whereMonth('created_at','=',$month)->whereYear('created_at','=',$year)->paginate(18);
        $post_data_archive = Post::with('rAllCategory')->whereMonth('created_at','=',$month)->whereYear('created_at','=',$year)->paginate(18);
