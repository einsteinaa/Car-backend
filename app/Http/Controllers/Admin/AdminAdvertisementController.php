...
class AdminAdvertisementController extends Controller
{
    ...
    public function home_ad_update(Request $request){
        ...
        return redirect()->back()->with('success', 'Data is upadeted sucessfully');
    ...
    public function sidebar_ad_store(Request $request){
        ...
        $request->validate([
            ...
            'sidebar_ad.image' => 'Not an image',
            'sidebar_ad.mimes'=>'Incorrect Image formate'
        ]);
            $now = time();
      ...
      return redirect()->route('admin_sidebar_ad_show')->with('success','Advertisement is created successfully');
    ...
    public function sidebar_ad_update(Request $request,$id){
      ...
      return redirect()->route('admin_sidebar_ad_show')->with('success','Advertisement is Updated successfully');
    ...
    public function sidebar_ad_delete($id){
        ...
        return redirect()->route('admin_sidebar_ad_show')->with('success','Advertisement is Deleted successfully');
